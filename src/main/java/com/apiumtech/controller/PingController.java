...
public class PingController extends SecureController {
    ...
    private MongoPingRepository repository() { return new MongoPingRepository(mongoTemplate); }
    private PingService service() { return new PingService(repository()); }
    private PingSystem system() { return new PingSystem(service()); }
